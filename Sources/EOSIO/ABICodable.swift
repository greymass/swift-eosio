                               ...
                               usingType type: ABI.ResolvedType) throws
{
    ...
    case .checksum160: try encodeS(Checksum160.self, value)
    case .checksum256: try encodeS(Checksum256.self, value)
    case .checksum512: try encodeS(Checksum512.self, value)
                       ...
                       from decoder: Decoder) throws -> Any
{
    ...
    case .checksum160: return try container.decode(Checksum160.self)
    case .checksum256: return try container.decode(Checksum256.self)
    case .checksum512: return try container.decode(Checksum512.self)
